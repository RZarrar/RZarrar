...
with st.sidebar:
    ...
    st.write("""
    **Zarrar Zafar** is a AI Engeenier, he's created this platform to make learning more interactive and fun.
    ...
    st.markdown(
        """
        - [🌐 r.zarrar7768@gmail.com]()
        """
    )

    st.divider()
    st.subheader("🏆 Rz Certificate", anchor=False)
    st.write("RZTube proudly stands Raahim Zafar YoutubeQuiz.It is for Quizes from A video.")

    st.divider()
    st.write("Made with Zarrar Zafar in Liaquat Pur, Pakistan")



st.title(":red[RZTube] — Watch. Learn. Quiz. 🔰", anchor=False)
st.write("""
Ever watched a course on YouTube You want to take a quiz from that video so, come to **RZtube** and test your comprehension!
...
with st.form("user_input"):
    ...
    OPENAI_API_KEY = st.text_input("Enter your OpenAI API Key:", placeholder="sk-XXXXXXXXXX", type='Key')
